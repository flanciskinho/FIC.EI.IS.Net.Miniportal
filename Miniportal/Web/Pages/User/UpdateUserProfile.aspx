...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder_BodyContent"
    ...
    <div id="form">
        <form id="UpdateUserProfileForm" method="POST" runat="server">
            ...
            <div class="field">
                <span class="oldLabel"><asp:Localize ID="lclFirstName" runat="server" meta:resourcekey="lclFirstName" /></span><span class="entry">
            ...
            <div class="field">
                <span class="oldLabel"><asp:Localize ID="lclSurname" runat="server" meta:resourcekey="lclSurname" /></span><span class="entry">
            ...
            <div class="field">
                <span class="oldLabel"><asp:Localize ID="lclEmail" runat="server" meta:resourcekey="lclEmail" /></span><span class="entry">
...
<%--            <div class="field">
            ...
            <div class="button">
                <asp:Button ID="btnUpdate" runat="server" OnClick="BtnUpdateClick" meta:resourcekey="btnUpdate" class="btn btn-large btn-primary"/>
            </div>
        </form>
    </div>
</asp:Content>
